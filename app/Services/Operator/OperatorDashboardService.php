...
class OperatorDashboardService
{
    ...
    public function __construct(StudentRepository $studentRepository, EmployeeRepository $employeeRepository, ClassroomRepository $classroomRepository, AttendanceRepository $attendanceRepository)
    {
    ...
    public function getMaster(): array
    {
        ...
        $presentToday = $this->attendanceRepository
            ->getByDate($today)
        ...
        return [
            ...
            'attendance_percentage_today' => $totalStudents
                ? round(($presentToday / $totalStudents) * 100, 2)
                : 0,
        ];
    }
