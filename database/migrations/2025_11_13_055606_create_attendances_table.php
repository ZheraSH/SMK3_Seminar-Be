...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('attendances', function (Blueprint $table) {
            ...
            $table->unsignedTinyInteger('lesson_order');
            ...
            $table->foreignUuid('overridden_by_permission_id')->nullable()->constrained('attendance_permissions')->nullOnDelete();
            $table->softDeletes();
            $table->timestamps();

            $table->index(['student_id', 'date']);
            $table->index(['student_id', 'date', 'lesson_order']);
            $table->index(['classroom_student_id', 'date']);
